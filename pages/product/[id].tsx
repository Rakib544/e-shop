...
const ProductDetails: React.FC = () => {
    ...
    const state = useSelector((state: RootStateOrAny) => state.getProductDetails);
    console.log(state)
                    ...
                    : (
                        <div className="container-lg px-8 py-14 mx-auto">
                            <div className="flex flex-wrap -m-4">
                                ...
                                <div className="p-2 sm:w-1/2 lg:w-1/4 shadow-sm" >
                                    <div className="p-4">
                                        ...
                                        <button className="bg-gray-900 text-white w-full py-3 mt-10 hover:bg-opacity-80 rounded">ADD TO CART</button>
                                    </div>
                                </div>
                            </div>
                        </div>
